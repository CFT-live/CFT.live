...
export const SetDataWaitWindow = ({
  ...
  const setValue = () => {
    writeToContract("setDataWaitWindow", [Number(inputValue)]);
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Data Wait Window</CardTitle>
        <CardDescription>
          Grace period for oracle data delay (in seconds).
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex gap-2 mb-4">
          <Input
            ...
            placeholder="Enter data wait window"
            disabled={isLoading}
          />
