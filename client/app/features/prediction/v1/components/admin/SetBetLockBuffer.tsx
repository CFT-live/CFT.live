...
export const SetBetLockBuffer = ({
  ...
  const setValue = () => {
    writeToContract("setBetLockBuffer", [Number(inputValue)]);
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Bet Lock Buffer</CardTitle>
        <CardDescription>
          Seconds before round close when betting locks (in seconds).
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex gap-2 mb-4">
          <Input
            ...
            placeholder="Enter bet lock buffer"
            disabled={isLoading}
          />
