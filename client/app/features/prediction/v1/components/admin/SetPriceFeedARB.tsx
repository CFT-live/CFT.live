...
export const SetPriceFeedARB = ({
  ...
  const setValue = () => {
    writeToContract("setPriceAddressFeedARB", [inputValue]);
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>ARB Price Feed Address</CardTitle>
        <CardDescription>
          Set the Chainlink price feed address for ARB/USD.
        </CardDescription>
      </CardHeader>
      <CardContent>
