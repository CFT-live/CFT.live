...
export const SetPriceFeedETH = ({
  ...
  const setValue = () => {
    writeToContract("setPriceAddressFeedETH", [inputValue]);
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>ETH Price Feed Address</CardTitle>
        <CardDescription>
          Set the Chainlink price feed address for ETH/USD.
        </CardDescription>
      </CardHeader>
      <CardContent>
