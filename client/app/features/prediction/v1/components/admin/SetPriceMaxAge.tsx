...
export const SetPriceMaxAge = ({
  ...
  const setValue = () => {
    writeToContract("setPriceMaxAge", [Number(inputValue)]);
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Price Max Age</CardTitle>
        <CardDescription>
          Maximum age of price data from oracle (in seconds).
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex gap-2 mb-4">
          <Input
            ...
            placeholder="Enter price max age"
            disabled={isLoading}
          />
