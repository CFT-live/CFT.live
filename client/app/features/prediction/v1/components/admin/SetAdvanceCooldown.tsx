...
export const SetAdvanceCooldown = ({
  ...
  const setValue = () => {
    writeToContract("setAdvanceCooldown", [Number(inputValue)]);
  };
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Advance Cooldown</CardTitle>
        <CardDescription>
          Minimum time between advance calls (in seconds).
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex gap-2 mb-4">
          <Input
            ...
            placeholder="Enter advance cooldown"
            disabled={isLoading}
          />
