...
export const GameHeader = ({ table }: Readonly<{ table: Table }>) => {
  ...
  return (
    <div className="rounded-lg border border-zinc-700/50 bg-zinc-950/55 px-3 py-3 sm:px-4 sm:py-4 shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Badge
          ...
          className="text-xs sm:text-sm px-2 sm:px-3 py-0.5 self-start"
        >
